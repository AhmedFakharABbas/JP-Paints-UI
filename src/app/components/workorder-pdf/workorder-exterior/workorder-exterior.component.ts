...
@Component({
  selector: 'app-workorder-exterior',
  templateUrl: './workorder-exterior.component.html',
  styleUrls: ['./workorder-exterior.component.css']
})
export class WorkorderExteriorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._route.params.subscribe(param => {
      ...
      if (!isNaN(this.project_id)) {
         ...
         this.generatedPdfName = "exterior" + this.project_id + "-work" + ".pdf";
      }
    });
