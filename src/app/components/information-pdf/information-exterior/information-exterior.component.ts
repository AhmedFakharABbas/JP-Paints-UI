...
@Component({
  selector: 'app-information-exterior',
  templateUrl: './information-exterior.component.html',
  styleUrls: ['./information-exterior.component.css']
})
export class InformationExteriorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._route.params.subscribe(param => {
      ...
      if (!isNaN(this.project_id)) {
        this.generatedPdfName = "exterior" + this.project_id + "-info" +  ".pdf" ;
