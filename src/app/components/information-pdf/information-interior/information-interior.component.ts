...
@Component({
  selector: 'app-information-interior',
  templateUrl: './information-interior.component.html',
  styleUrls: ['./information-interior.component.css']
})
export class InformationInteriorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._route.params.subscribe(param => {
      ...
      if (!isNaN(this.project_id)) {
        this.generatedPdfName = "interior" + this.project_id + "-info" + ".pdf";
